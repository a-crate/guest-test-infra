...
var x86shapes = map[string]*shape{
	...
	"N4": {
		...
		mem:             640,
		numa:            1,
		disks:           []*compute.Disk{{Name: "N4", Type: imagetest.PdBalanced}},
		quota:           &daisy.QuotaAvailable{Metric: "CPUS", Units: 80},
		requireFeatures: []string{"GVNIC"},
	},
	"N4-HyperdiskBoot": {
		name:            "n4-highmem-80",
		...
		mem:             640,
		numa:            1,
		disks:           []*compute.Disk{{Name: "N4", Type: imagetest.HyperdiskBalanced}},
		quota:           &daisy.QuotaAvailable{Metric: "CPUS", Units: 80},
		requireFeatures: []string{"GVNIC"},
	},
	"N2": {
